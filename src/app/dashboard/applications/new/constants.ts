export const businessTypes = [
  ...
  { id: 'limited_by_guarantee', icon: '🤝', name: 'Company Limited by Guarantee', desc: 'For NGOs, associations, and non-profits. No share capital required.', price: 1700, formRef: 'Form 3', timeline: '10-15 working days' },
]
